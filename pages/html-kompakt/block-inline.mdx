...
<h1 style={{fontFamily: "serif", border: "1px solid black", padding: "3px"}}>Überschrift</h1>
<p style={{fontFamily: "serif", border: "1px solid black", padding: "3px"}}>Ein Absatz mit Text</p>
<h2 style={{fontFamily: "serif", border: "1px solid black", padding: "3px"}}>Nächste Überschrift</h2>
<p style={{fontFamily: "serif", border: "1px solid black", padding: "3px"}}>Wieder ein Absatz.</p>
